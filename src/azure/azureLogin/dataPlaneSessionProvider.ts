...
import { AzureAuthenticationSession, AzureDataSessionProvider, GetAuthSessionOptions, SignInStatus, Tenant } from "./authTypes";
...
export namespace DataPlaneSessionProviderHelper {
    ...
    class DataPlaneSessionProviderImpl extends VsCodeDisposable implements AzureDataSessionProvider {
