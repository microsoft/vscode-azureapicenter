...
export default function (context: any): string {
    return `You are an expert in ${context.vars.param1} programming language and OpenAPI.
    Generate the OpenAPI Specification from the provided ${context.vars.param1} programming language.
    ...
    Here's the ${context.vars.param1} code of Web API:
    \`\`\`
    ${context.vars.param2}
    \`\`\``;
}
