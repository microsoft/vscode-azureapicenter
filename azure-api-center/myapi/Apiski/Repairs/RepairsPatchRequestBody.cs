...
namespace Apiski.Repairs {
    public class RepairsPatchRequestBody : IParsable {
...
#nullable restore
        ...
        public string Description { get; set; }
#endif
        /// <summary>The unique identifier of the repair to update</summary>
...
#nullable restore
        ...
        public static RepairsPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RepairsPatchRequestBody();
        }
        /// <summary>
