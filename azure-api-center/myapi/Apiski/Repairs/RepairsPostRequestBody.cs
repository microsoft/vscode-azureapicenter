...
namespace Apiski.Repairs {
    public class RepairsPostRequestBody : IParsable {
...
#nullable restore
        ...
        public string AssignedTo { get; set; }
#endif
        /// <summary>The optional date and time when the repair is scheduled or completed</summary>
...
#nullable restore
        ...
        public static RepairsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RepairsPostRequestBody();
        }
        /// <summary>
